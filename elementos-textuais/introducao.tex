...
\begin{compactitem}
    \item \textbf{Capítulo~\ref{chp:FUNDAMENTACAO}:} apresenta a fundamentação teórica necessária à compreensão do projeto, discutindo dados, metadados, gestão de dados de pesquisa, os princípios FAIR, dados abertos e licenciamento, versionamento de dados e o formato CSV;

    \item \textbf{Capítulo~\ref{chp:PROPOSTA}:} descreve a proposta do DataRural, sua visão geral, os trabalhos relacionados, os requisitos do sistema, o controle de acesso, a modelagem de dados e a arquitetura proposta;

    \item \textbf{Capítulo~\ref{chp:EXPERIMENTOS}:} detalha a implementação da plataforma, justifica as tecnologias adotadas, descreve a organização do código e apresenta os principais fluxos e interfaces disponibilizados aos usuários;
