...
\begin{compactitem}
    ...
    \item \textbf{Capítulo~\ref{chp:PROPOSTA} --- DataRural:} apresenta a proposta da plataforma, compara a solução com plataformas existentes, demonstra os principais fluxos e interfaces do sistema, define os requisitos, o controle de acesso e a modelagem de dados;
