...
A entidade \textit{dataset\_likes} registra as curtidas dos usuários em datasets. As curtidas funcionam como uma forma simples de interação pública, permitindo que a comunidade sinalize interesse e relevância. A Tabela~\ref{tab:entity_dataset_likes} apresenta sua estrutura.
...
A entidade \textit{dataset\_favorites} registra os datasets favoritados por cada usuário, possibilitando acesso rápido a conjuntos de interesse pessoal. Diferentemente das curtidas, os favoritos criam uma coleção privada que não altera a propriedade nem a visibilidade do conjunto. A Tabela~\ref{tab:entity_dataset_favorites} apresenta sua estrutura.
