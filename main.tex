...
\title{DataRural: Um Repositório Institucional de Datasets para a UFRRJ}

% autor é obrigatório; máximo de 3 autores
\author{Rafael Vieira da Silva}{\input{elementos-pretextuais/agradecimentos-rafael}}
\author{Helcio Duarte Dantas}{\input{elementos-pretextuais/agradecimentos-helcio}}
...
\banca[Prof.]{Bruno José Dembogurski,~D.Sc.}{DCC~-~UFRRJ}
